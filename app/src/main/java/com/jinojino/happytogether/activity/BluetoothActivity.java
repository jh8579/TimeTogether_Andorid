    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v){
                NotificationManager notificationManager= (NotificationManager)BluetoothActivity.this.getSystemService(BluetoothActivity.this.NOTIFICATION_SERVICE);
                ...
                Intent intent = new Intent(BluetoothActivity.this.getApplicationContext(),BluetoothActivity.class); //인텐트 생성.
                ...
                PendingIntent pendingNotificationIntent = PendingIntent.getActivity( BluetoothActivity.this,0, intent,PendingIntent.FLAG_UPDATE_CURRENT);
...
//               setConentText->푸쉬내용
               ...
               Intent nextIntent=new Intent(BluetoothActivity.this, ListActivity.class);
